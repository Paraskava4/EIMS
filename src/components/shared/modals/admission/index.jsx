...
const AdmissionModal = () => {
    ...
    const countPendingFees = useCallback(() => {
    ...
    useEffect(() => {
        ...
        setBatchOption(handleBatchesOption(batchs));
        setStandardOption(handleStandardOption(standards));
        setShiftOption(handleShiftOption(shifts));

        setValue("studentId", studentId ?? "");
        setValue("standardId", student?.standardId?._id);
        setValue("batchId", student?.batchId?._id ?? "");
        setValue("shiftId", student?.shiftId?._id ?? "");

        setValue("discount", student?.discount ?? "0");
        setValue("totalFees", feesDetailsResponse?.data?.student?.fees ?? null);
        setValue("rollNumber", student?.rollNumber ?? "");
        countCollectedFees(studentFees);
        countPendingFees();
    }, [feesDetailsResponse, studentId, setValue, countCollectedFees, countPendingFees, handleBatchesOption, handleStandardOption, handleShiftOption]);
    ...
    return (
        <Modal show={open} onHide={handleClose} size="xl" className="overflow-hidden" centered>
            <Modal.Body className="bg-white modal__body">
                        ...
                        <Row className="mb-2">
                            ...
                            <Col sm={12} lg={4} className="mt-4 mt-lg-0">
                                <ModifiedSelect
                                    ...
                                    CustomLabelStyle={"admissionLabel"}
                                    CustomSelectStyle={admissionFormSelect}
                                    isDisabled={feesDetailsResponse?.data?.student?.isConfirm}
                                />
                            </Col>
                            <Col sm={12} lg={4} className="mt-4 mt-lg-0">
                                <InputItem
                        ...
                        <Row className="mb-2">
                            ...
                            <Col sm={12} lg={4}>
                                <InputItem
                                    ...
                                    className={"admissionInput"}
                                    classNameLabel={"admissionLabel"}
                                    disabled={feesDetailsResponse?.data?.student?.isConfirm}
                                />
                            </Col>
                        </Row>
                        <Row className="mb-2">
