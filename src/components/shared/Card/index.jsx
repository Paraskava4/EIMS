...
import Img_placeholder from "../../../assets/images/demo-img/placeholder.svg";
        ...
        <div className="d-flex align-items-center p-2 card_style">
            <div className="text-center mx-auto">
                <div className="mx-auto" style={{ width: "67px", height: "74px" }}>
                    <img src={studentData?.photo || Img_placeholder} alt={"ProfilePhoto"} width={74} height={74} className="w-100 mx-auto d-block image" />
                </div>
                <p className="fs-6">
