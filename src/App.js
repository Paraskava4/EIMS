...
import "./views/styles/datepicker.scss";
import { Loader } from "./components/shared/Loader";
import Category from "./components/shared/modals/category";
...
const PasswordModal = lazy(() => import("./components/shared/modals/password"));
...
function App() {
    ...
    useEffect(() => {
        const storedUserId = JSON.parse(sessionStorage.getItem("selectedUserId"));
        dispatch(actions.student.setStudentId(storedUserId));
    }, []);
        ...
        <Fragment>
            <Router>
                ...
                <Suspense fallback={<Loader />}>
                    ...
                    {modal?.category?.open && <Category data={modal?.category?.data} />}
                </Suspense>
            </Router>
