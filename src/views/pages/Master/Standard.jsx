...
const Standard = () => {
    ...
    const { data } = useGetStandardQuery(null, { refetchOnMountOrArgChange: true });
    ...
    const handleOpen = (e, data = { open: true, data: null }) => actions.modal.openStandard(data);
    const handleOpenDelete = (e, id) => actions.modal.openDelete({ id, type: "STANDARD" });
