...
const Subject = () => {
    ...
    const { data } = useGetSubjectQuery(null, { refetchOnMountOrArgChange: true });
    ...
    const handleOpen = (e, data = { open: true, data: null }) => actions.modal.openSubject(data);
    const handleOpenDelete = (e, id) => actions.modal.openDelete({ id, type: "SUBJECT" });
