...
import { useCheckAttendanceQuery, useTakeAttendanceMutation } from "../../../api/student";
...
const TakeAttendance = () => {
    ...
    useEffect(() => {
        if (!isStatusInclude(attendanceData?.status)) return;
    ...
    return (
        <Form onSubmit={handleSubmit(handleAttendanceSubmit)} className="position-relative pe-2" style={{ height: "78vh" }}>
            <Row>
                <Col sm={12} md={6} lg={4}>
                    <Label name="Standard" title="Standard" classNameLabel={"default_label"} />
                    <StandardSelect
                ...
                <Col sm={12} md={6} lg={4} className="overLay">
                    <Label name={"date"} title="Date" classNameLabel={"default_label"} />
                    <Controller
                        name="date"
                        control={control}
                ...
                <Col sm={12} md={6} lg={4}>
                    <Label name="Batch" title="Batch" classNameLabel={"default_label"} />
                    <BatchSelect
                        styles={StandardModifiedSelectStyle}
                        handleChange={(batch) => {
            ...
            <div className="border border-dark" style={{ height: "calc(100vh - 415px)", overflow: "auto" }}>
                <Table items={studentRecord} columns={column} rowClass={"cursor_pointer"} className="attendance_table" />
            </div>
