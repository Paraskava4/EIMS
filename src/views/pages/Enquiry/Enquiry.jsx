import React, { forwardRef, useEffect, useImperativeHandle, useLayoutEffect, useRef, useState, memo } from "react";
...
import { getMonth, getYear, parse, isValid, addYears } from "date-fns";
...
const Enquiry = memo(() => {
    ...
    useEffect(() => {
        ...
        const selectedDate = isValid(parsedDate) ? parsedDate : addYears(new Date(), -6);
    ...
    const onSubmitFirstForm = () => {
        navigate("/enquiry/form-second", { state: location?.state });
    };
                ...
                <div className="form-container">
                    <Form noValidate onSubmit={handleSubmit(onSubmitFirstForm)}>
                            ...
                            <div className="d-sm-block d-md-flex w-100">
                                <div style={{ width: "115px" }}>
                                    <ModifiedSelect
                                        ...
                                        className="w-100"
                                        CustomSelectStyle={standardSelectStyle}
                                ...
                                <Row className="w-100 ms-0 ms-md-2">
                                    <Col sm={12} md={4}>
                                        <InputItem
                                            ...
                                            form={form}
                                            size={4}
                                            classNameLabel={"d-block text-truncate default_label"}
                        ...
                        <Row className="mb-2">
                            <Col sm={12} md={3}>
                                <InputItem
                                    ...
                                    form={form}
                                    size={3}
                                    classNameLabel={"default_label d-block text-truncate"}
                                    className={"form__input border-0 form-control-lg"}
                                />
                            </Col>
                            <Col sm={12} md={9}>
                        ...
                        <Row className="mb-2">
                            <Col sm={12} md={4}>
                                ...
                                <Controller
                                    ...
                                    render={({ field: { value, onChange } }) => {
                                        ...
                                        const maxDate = new Date(maxYear, 11, 31); // Set the maxDate to December 31st of the six years ago
                                        return (
                                            <>
                            ...
                            <Col sm={12} md={4}>
                                <GenderSelection control={control} name={"gender"} classNameLabel={"default_label"} />
                            </Col>
                        </Row>
...
const GenderSelection = ({ control, name }) => {
    return (
        <Form.Group as={Col} md="8">
            <Form.Label className="enquiry-label default_label">Gender</Form.Label>
