...
import { useCreateStaffMutation, useUpdateStaffMutation } from "../../../api/staff";
...
const CreateUpdateStaff = () => {
    ...
    useErrorCatcher({ error: createStaffError || updateStaffError, isError: isCreateError || isUpdateError });
    ...
    const onSubmitForm = async (data) => {
        const formattedDateOfBirth = format(new Date(data.dateOfBirth), "dd/MM/yyyy");
        const body = {
            ...data,
    ...
    useEffect(() => {
        ...
        const parsedDate = parse(prefillData?.dateOfBirth, "dd/MM/yyyy", new Date());
    ...
    }, [prefillData, setValue, isEditMode]);
                    ...
                    <Row className="mb-2">
                        <div className="d-md-flex w-100">
                            <ModifiedSelect
                                ...
                                CustomSelectStyle={staffSelectStyle}
                            />
