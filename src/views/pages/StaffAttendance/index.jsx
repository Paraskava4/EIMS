                    ...
                    label: (
                        <div className="position-relative">
                            <div className={`calendar-header ${isCurrentDate ? "current_primary" : ""}`}>
                                {index === 0 && (
                                    <div className="scroll-arrow position-absolute start-0" onClick={scrollPrevious}>
                                        &lt;
                                    </div>
                                )}
                                ...
                                {index === arrayOfWeek.length - 1 && (
                                    <div className="scroll-arrow position-absolute end-0" onClick={scrollNext}>
                                        &gt;
                                    </div>
                                )}
                            </div>
