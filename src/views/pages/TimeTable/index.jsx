            ...
            <Container fluid className="mt-3 exam-container">
                <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Row className="mb-2">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="align-self-center">
                                        ...
                                        <input type="file" accept="image/*" onChange={handleFileChange} id="fileSelect" className="d-none" />
                    ...
                    <div className="d-flex justify-content-center">
                        <button type="submit" className="submit_button fs-4 fw-bold mx-auto d-block px-5 py-2">
